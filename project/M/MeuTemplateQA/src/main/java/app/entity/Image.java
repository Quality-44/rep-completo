...
/**
* Classe que representa a tabela IMAGE
* @generated
*/
@jakarta.persistence.Entity
@jakarta.persistence.Table(name = "\"IMAGE\"")
@XmlRootElement
@CronappSecurity
@JsonFilter("app.entity.Image")
...
public class Image implements Serializable {
    ...
    * @generated
    */
    @CronappColumn(attributeType="IMAGE_DATABASE", label="Image")
